...
protected:
    ...
    void Generic_setup(const std::string& test_type)
    {
        ...
        if (request.len > 0) {
            ...
            std::copy(data_in_temp, data_in_temp + (request.len + 7) / 8, request.data);
...
#ifdef _BBLIB_SNC_
TEST_P(Crc24AGeneratePerf, Gen_CRC24A_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24a_gen_snc, &request, &response);
}

TEST_P(Crc24AValidatePerf, Val_CRC24A_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24a_check_snc, &request, &response);
}

TEST_P(Crc24BGeneratePerf, Gen_CRC24B_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24b_gen_snc, &request, &response);
}

TEST_P(Crc24BValidatePerf, Val_CRC24B_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24b_check_snc, &request, &response);
}

TEST_P(Crc24CGeneratePerf, Gen_CRC24C_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24c_gen_snc, &request, &response);
}

TEST_P(Crc24CValidatePerf, Val_CRC24C_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc24c_check_snc, &request, &response);
}

TEST_P(Crc16GeneratePerf, Gen_CRC16_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc16_gen_snc, &request, &response);
}

TEST_P(Crc16ValidatePerf, Val_CRC16_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc16_check_snc, &request, &response);
}

TEST_P(Crc11GeneratePerf, Gen_CRC11_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc11_gen_snc, &request, &response);
}

TEST_P(Crc11ValidatePerf, Val_CRC11_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc11_check_snc, &request, &response);
}

TEST_P(Crc6GeneratePerf, Gen_CRC6_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc6_gen_snc, &request, &response);
}

TEST_P(Crc6ValidatePerf, Val_CRC6_SNC_Perf)
{
    performance("SNC", module_name, bblib_lte_crc6_check_snc, &request, &response);
}
