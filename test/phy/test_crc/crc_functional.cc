...
#if defined(_BBLIB_SSE4_2_) || defined(_BBLIB_AVX2_) || defined(_BBLIB_AVX512_)||defined(_BBLIB_SNC_)
...
/* CRC byte length based, SNC, Generation & Check Tests*/
#ifdef _BBLIB_SNC_

TEST_P(CrcByteLenGenerationCheck, CRC6_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc6_value");
    functional_gen(bblib_lte_crc6_gen_snc, "SNC");
    functional_chk(bblib_lte_crc6_check_snc, "SNC");
}

TEST_P(CrcByteLenGenerationCheck, CRC11_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc11_value");
    functional_gen(bblib_lte_crc11_gen_snc, "SNC");
    functional_chk(bblib_lte_crc11_check_snc, "SNC");
}

TEST_P(CrcByteLenGenerationCheck, CRC16_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc16_value");
    functional_gen(bblib_lte_crc16_gen_snc, "SNC");
    functional_chk(bblib_lte_crc16_check_snc, "SNC");
}

TEST_P(CrcByteLenGenerationCheck, CRC24A_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc24a_value");
    functional_gen(bblib_lte_crc24a_gen_snc, "SNC");
    functional_chk(bblib_lte_crc24a_check_snc, "SNC");
}

TEST_P(CrcByteLenGenerationCheck, CRC24B_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc24b_value");
    functional_gen(bblib_lte_crc24b_gen_snc, "SNC");
    functional_chk(bblib_lte_crc24b_check_snc, "SNC");
}

TEST_P(CrcByteLenGenerationCheck, CRC24C_SNC)
{
    reference.crc_value = get_reference_parameter<uint32_t>("crc24c_value");
    functional_gen(bblib_lte_crc24c_gen_snc, "SNC");
    functional_chk(bblib_lte_crc24c_check_snc, "SNC");
}
#endif
